...
RSpec.describe 'Projects show page' do
  ...
  describe 'Story 1' do
    describe 'when I visit a projects show page' do
      it 'I see that projects name and materials and the theme of the challenge' do
  ...
  describe "Story 3" do
    it "shows the count of the number of contestants on this project" do
      ...
      #  save_and_open_page
      expect(page).to have_content("Challenge Materials: #{@boardfit.material}")
      expect(page).to have_content("Number of Total Contestants: 2")
    end
  end
end
